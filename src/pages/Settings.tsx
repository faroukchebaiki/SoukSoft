...
import type { AccountProfile, SettingOption } from "@/types";
...
export function Settings({ profile, personalOptions, onGoHome }: SettingsProps) {
  useEffect(() => {
    if (!onGoHome) return;
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              These preferences stay with your login across all sections.
            </p>
          </div>
